<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashboardUser.aspx.cs" Inherits="Proyek.AdminDashboardUser" %>
                    ...
                    <div>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                ...
                                <br />
                                <br />
                                Address<br />&nbsp;<asp:TextBox ID="tb_name0" runat="server"></asp:TextBox>
                                <br />
                                <br />
                                Phone Number<br />
                                ...
                                <br />
                                <asp:RadioButton ID="RadioButton2" runat="server" Text="Non Active" />
                                <br />
                                &nbsp;<br />
